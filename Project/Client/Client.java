...
INSTANCE;
    ...
    private static final String LIST_ROOMS = "/list";
    ...
    private void sendListRoom(String searchString) throws IOException{
        Payload p = new Payload();
            ...
            case MESSAGE:
                ...
                try{
                    ...
                    for(int i = 0; i < rooms.size(); i++ ){
                        String msg = (String.format("%s %s", (i+1), rooms.get(i), rooms.get(i)));
